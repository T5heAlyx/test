...
head
    ...
    link rel=shortcut icon type=imagepng href=imgfavicon.png 

    titleFirmware Updatetitle
head
    ...
    header class=header
        div class=header__text-box
            h1 class=heading-primary
                span class=heading-primary--mainNew Updatespan
                span class=heading-primary--subis now availablespan
            h1

            a href=#section-update class=btn btn--white btn--animationget started »a
        div
    header
    main
            ...
            div class=feature-box
                div class=feature-box__items
                    svg class=feature-box__icon u-margin-bottom-small
                        use xlinkhref=imgsprites.svg#icon-connectionuse
                    svg
                ...
                div class=feature-box__items
                    svg class=feature-box__icon u-margin-bottom-small
                        use xlinkhref=imgsprites.svg#icon-meteruse
                    svg
                    p class=feature-box__text
                ...
                div class=feature-box__items
                    svg class=feature-box__icon u-margin-bottom-small
                        use xlinkhref=imgsprites.svg#icon-buguse
                    svg
                    p class=feature-box__text
                ...
                div class=feature-box__items
                    svg class=feature-box__icon u-margin-bottom-small
                        use xlinkhref=imgsprites.svg#icon-shielduse
                    svg
                    p class=feature-box__text
        ...
        section class=section-update id=section-update
                    ...
                    form class=form onsubmit=return false
                        ...
                        div class=form__group
                            input type=password class=form__input placeholder=Password id=pass pattern=[A-Za-z0-9!@#$%^&-+_=]{8,}
                                required 
                            label for=pass class=form__labelPasswordlabel
                        div
                        ...
                        div class=form__group
                            button class=btn btn--green id=form-buttonNext step →button
                        div
                    form
                div
            div
            div class=progress
                ...
                div class=progress__text
                    span class=progress__text--main id=progress__percentage0%span
                    span class=progress__text--subCompletedspan
                div
            div
        section
    main
